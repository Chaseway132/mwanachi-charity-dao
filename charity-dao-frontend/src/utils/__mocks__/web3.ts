export const getProvider = jest.fn().mockResolvedValue({
...
export const getProposalManagementContract = jest.fn().mockResolvedValue({
...
export const getDonationContract = jest.fn().mockResolvedValue({
